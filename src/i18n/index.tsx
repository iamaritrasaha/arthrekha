...
export const translations: Record<Language, Record<string, string>> = {
  ...
  'bn-IN': {
    ...
    'India financial year runs from April to March.': 'ভারতের অর্থবর্ষ এপ্রিল থেকে মার্চ পর্যন্ত।',
    'Actual data is available through {period} {year}; later periods are not available.': '{period} {year} পর্যন্ত বাস্তব তথ্য রয়েছে; পরের সময়ের তথ্য নেই।',
    'Recorded cumulative periods run through {period} {year}; later periods are not available in this dataset.': '{period} {year} পর্যন্ত জমাকৃত সময়কাল নথিবদ্ধ; এই ডেটাসেটে পরের সময়কাল নেই।',
    'latest: {period} {year}': 'সর্বশেষ: {period} {year}',
    'Provisional cumulative Union Government actuals from the available fiscal-year reporting periods.': 'উপলব্ধ অর্থবর্ষের রিপোর্টিং সময়কাল থেকে কেন্দ্রীয় সরকারের জমাকৃত অস্থায়ী বাস্তব তথ্য।',
